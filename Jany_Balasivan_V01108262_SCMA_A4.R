...
survey_df<-read.csv("/Users/janybalashiva/Downloads/Survey (1).csv",header=TRUE) 
dim(survey_df) 
names(survey_df) 
head(survey_df) 
str(survey_df)
...
icecream_df<-read.csv('/Users/janybalashiva/Downloads/icecream.csv',header=TRUE)
dim(icecream_df)
...
#conjoint analysis
# Load data
df <- read.csv('/Users/janybalashiva/Downloads/pizza_data.csv')
